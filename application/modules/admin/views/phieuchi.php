...
<div id="body">
    <div id="header">
        <div id="logo">
            <img src="<?php $this->load->model('mconfig'); echo base_url() ?>public/default/img/icon/<?php echo $this->mconfig->getByKey('pbh_logo') ?>">
        </div>
        <div id="info">
            <form id="form" method="post" enctype="multipart/form-data">
                ...
                <table style="width: 40% ; float: left">
                    <tr>
                        ...
                        <td style="vertical-align: top;text-align: center"><h3>PHIẾU CHI</h3></td>
                    </tr>
                    <tr>
    ...
    <div class="print-hide">
        <button class="view" type="button" onclick="window.print();return false;" class="print-hide">In Phiếu Chi</button>
        <button class="view" id="save" class="print-hide">Lưu Phiếu Chi</button>
    </div>
    </form>
</div>
...
<script>
    ...
    $("#select-cus").change(function(){
        ...
        $.ajax({
            ...
            success: function(string){
                ...
                $('#code').html(time2+'-'+time+'/PC-'+getData.code);
    ...
    $(document).on('submit','#form',function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url() ?>"+'admin/index/phieuchi',
